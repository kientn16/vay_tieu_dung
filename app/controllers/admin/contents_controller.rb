class Admin::ContentsController < ApplicationController
  ...
  def destroy
    @content.destroy
    respond_to do |format|
      format.html { redirect_to admin_contents_path, notice: 'Content was successfully destroyed.' }
  ...
  def content_params
    params.require(:content).permit(:title, :description, :content, :status, :type)
  end
end
